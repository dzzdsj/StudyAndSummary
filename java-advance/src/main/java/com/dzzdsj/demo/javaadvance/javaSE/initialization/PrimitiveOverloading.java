package com.dzzdsj.demo.javaadvance.javaSE.initialization;//: initialization/PrimitiveOverloading.java
// Promotion of primitives and overloading.


import static com.dzzdsj.demo.javaadvance.javaSE.util.Print.print;
import static com.dzzdsj.demo.javaadvance.javaSE.util.Print.printnb;

/**
 * 如果入参是基础类型时，形参类型的过载会产生自动转型。可能会丢失类型信息。需要注意
 */
